...
if(!empty($_POST["UIDresult"]))
{
    ...
    $sql1 = "INSERT INTO traffic(rftag,date, pays, lieu, type_even ) VALUES ('".$_POST['UIDresult']."','".$dt."', 'Tunisia' , 'Agence Rapid-Poste Carthage' , 'Recevoir les envois du client')";
	...
	*/
    ...
    //Email body
	$mail->Body = "Votre clis d'id : '".$_POST['UIDresult']."' est a l'agence Rapid-Poste Carthage"." le ".$d." a ".$t;
	//Add recipient
